...
base_dir = f"logs_twoagent_s{seed[seed_id]}/"
...
for i, file in enumerate(game_files):
    ...
    for cnt in range(run_times):
        try:
            ...
            user_proxy.initiate_chat(assistant, message="", clear_history=False)
            ...
            # with open(f"{base_dir}{correct_prefix}/{i}_cost.json", "w") as f:
            #     json.dump(total_usage_summary, f, indent=4)
...
# success_avg = success_all // run_times
